...
def _tf_repositories():
    ...
    tf_http_archive(
        ...
        urls = ["http://localhost:8088/rules_apple.0.31.3.tar.gz",],
    )
    ...
    tf_http_archive(
        ...
        urls = ["http://localhost:8088/rules_swift.0.21.0.tar.gz",],
    )
    ...
    tf_http_archive(
        ...
        urls = ["http://localhost:8088/apple_support.0.10.0.tar.gz",],
    )
